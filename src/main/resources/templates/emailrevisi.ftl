                              ...
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;font-size:0px"><a
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:18px"><img
                                      src="https://mddofk.stripocdn.email/content/guids/CABINET_f6d4e90a5ac67ec2aa736d076f75f82476a5aa7c632198cff2d94261102e4c44/images/mii_logo.jpg"
                                      alt="Confirm email"
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa"
                              ...
                              <tr>
                                <td align="center" style="padding:20px;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                    Berdasarkan tinjauan dari Kami, CV yang Saudara buat masih terdapat kekeliruan.
                                    Saudara dapat membaca panduan untuk mengupload CV dan diharapkan segera melakukan
                                    revisi CV pada web JobMii. </p>
                              </tr>
                            </table>
                          </td>
                        </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0">
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                    <br>PT Mitra Intergrasi Informatika</p>
                                </td>
                              </tr>
                              <tr>
                                <td align="center"
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                                    ...
                                    <tr>
                                      <td align="center" class="es-m-txt-l" style="padding:0;Margin:0;font-size:0px"><a
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:18px"><img
                                            src="https://mddofk.stripocdn.email/content/guids/CABINET_ee77850a5a9f3068d9355050e69c76d26d58c3ea2927fa145f0d7a894e624758/images/group_4076325.png"
                                            alt="Demo"
